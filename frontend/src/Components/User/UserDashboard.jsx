...
function UserDashboard() {
    const userList = useSelector((state) => {
        state.login.userList

    })
    console.log("user in dashboard", userList);
    ...
    return (
        <body class="relative bg-yellow-50 overflow-hidden max-h-screen">
                ...
                <div class="flex flex-col justify-between h-full">
                    <div class="flex-grow">
                        <div class="px-4 py-6 text-center border-b">
                            <h1 class="text-xl font-bold leading-none"><span class="text-yellow-700">Serenity</span> Dashboard</h1>
                        </div>
                        <div class="p-4">
                            <ul class="space-y-1">
                                <li>
            ...
            <main class="ml-30 pt-16 max-h-screen overflow-auto">
                <div class="px-6 py-8">
                    <div class="max-w-4xl mx-auto">
                        <div class="bg-white rounded-3xl p-8 mb-5">
                            <h1 class="text-3xl font-bold mb-10">Manage your sessions here</h1>
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-x-2">
                                    <button type="button" class="inline-flex items-center justify-center h-9 px-3 rounded-xl border hover:border-gray-400 text-emerald-600 hover:text-gray-900 transition">
                                    ...
                                    <button type="button" class="inline-flex items-center justify-center h-9 px-5 rounded-xl bg-emerald-600 text-white hover:text-white text-sm font-semibold transition">
                                        Open
                                    </button>
                                </div>
                            </div>
