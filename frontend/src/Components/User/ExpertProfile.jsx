...
function ExpertProfile() {
    ...
    // const specialization = expert[0]
    // console.log("spe", expert[0]);
    // const array = expert.specialization
    // const [o, t, th] = array
    // console.log(o, t, th);   
    // const array = expert
    // console.log("arrat", array.specialization);
                        ...
                        <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                            <div className="px-6">
                                <div className="flex flex-wrap justify-center">
                                    <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                                        <div className="relative">
                                            <img alt="..." src={ExpertImg} className=" shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -ml-20 lg:-ml-16 max-w-150-px" />
                                        </div>
                                    </div>
                                    <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                                        <div className="py-6 px-3 mt-32 sm:mt-0">
                                            <button onClick={bookingHandler} className="bg-emerald-600 active:bg-pink-600 uppercase text-white font-bold hover:bg-emerald-900 text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                                                Book now
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div className="text-center mt-12">
                                    ...
                                    {/* {expert[0].specialization.map((item) => {
                                            <li>{item}</li>
                                        })} */}
